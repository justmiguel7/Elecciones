...
@WebServlet( urlPatterns =  "/PadronEliminar")
public class PadronEliminar extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id == null || id.trim().isEmpty()) {
            ...
            req.getRequestDispatcher("/loadPadronFormBaja").forward(req, resp);
            return;     
        }
        
        int idInt = Integer.parseInt(id);
        try {
		  padronService.delete(idInt);
		   ...
		   obj.addProperty("mensaje","Se elimino correctamente el padron");
