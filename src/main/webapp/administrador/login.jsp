...
<head>
    ...
    <script src="${pageContext.request.contextPath}/scripts/cargarDatosAdmin.js"></script>
</head>
...
<body>
	<div class="wrapper fadeInDown">
		<div id="formContent" class="fadeInDown">
			...
			<h2 class="active fadeIn second">Administrador</h2>

			<form id="Login">
				<input type="text" id="usuario" class="fadeIn second" name="usuario" placeholder="Administrador" required>
